...
```{r}
#| label: fig-ppcheck-postprior
#| echo: false
#| fig-pos: H
#| message: false

pp_check(analysis_model) + theme_classic()

posterior_vs_prior(analysis_model) + theme_classic() + coord_flip()
```
